            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <p style="color: red;">
                        ...
                        if (isset($error_pay['address'])){
                            echo '*';
                            echo $error_pay['address'];
                ...
                <div class="form-group">
                    ...
                    <p style="color: red;">
                        ...
                        if (isset($error_pay['mobile'])){
                            echo '*';
                            echo $error_pay['mobile'];
                          ...
                          <tr>
                              <td>
                                <?php if (!empty($cart['avatar'])): ?>
                                    <img class="product-avatar img-responsive" id="avatar-payment"
