...
<body>	
	...
	<form  name="NLpayBank" action="" method="post">
		<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td>Họ Tên: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_fullname" class="field-check " value="<?php echo $_SESSION['payment']['fullname'] ?>">
				</td>
			</tr>
			<tr><td>Email: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_email" class="field-check " value="<?php echo $_SESSION['payment']['email'] ?>">
				</td>
			</tr>
			<tr><td>Số Điện thoại: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_mobile" class="field-check " value="<?php echo $_SESSION['payment']['mobile'] ?>">
				</td>
			</tr>				
		</table>	
